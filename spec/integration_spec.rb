...
- initial_board: |
  ...
  it 'can fetch editor' do
    response = bridge.assets 'editor/editor.html'
    expect(response).to include('mu-gobstones-custom-editor')
    expect(response).to include('procedure After')
    expect(response).to include('procedure Before')
    expect(response).to include('procedure ShiftTo')
  end

  it 'can fetch media assets' do
    response = bridge.assets 'media/sprites.png'
...
- initial_board: |
  ...
  final_board: |
    ...
    it 'answers a valid hash when submission is textual, collides as expected and passes' do
      response = bridge.run_tests!(
        test: %q{
examples:
- initial_board: |
